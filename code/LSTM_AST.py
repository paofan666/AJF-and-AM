...
train_data = pd.read_csv('D:/Code/java/lucene_data/train_composite_data_ast.csv')
test_data = pd.read_csv('D:/Code/java/lucene_data/test_composite_data_ast.csv')
#读取训练和测试的X和Y
...
features = 40#每个时间步的特征数量
#创建模型
model = tf.keras.models.Sequential()
model.add(tf.keras.layers.LSTM(50, input_shape=(1, features), return_sequences=True))
